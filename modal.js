...
for(var i = 0; i < cardholders.length; i++) {
    (function(index) {
        cardholders[index].addEventListener("click", function() {
            ...
            if(modal.classList.contains("comedy")) {
                modalTitle.innerHTML = comedyArtists[index].name;
                modalDescription.innerHTML = comedyArtists[index].description;
                modalImage.src = comedyArtists[index].image;
            } else {
